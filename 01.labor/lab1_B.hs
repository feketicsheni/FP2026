...
paratlanOsszetett2 n=[i | i<-[1..n], not (primszam i), mod i 2 /=0, not (even i)]

paratlanOsszetett3 n=[i | i<-[1..n], not (primszam i), mod i 2 /=0, odd i]
...
main = do
  ...
  let ep1=(6,7)
  putStrLn("elempar (6,7) (4,7)" ++ show ep1 ++ " "++  show (elempar2 (6,7) (4,7)))
